import svgPaths from "./svg-gogw1udwjz";
...
function Frame() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-end justify-end relative shrink-0 w-full">
      <TextInput1 />
      <p className="[text-decoration-skip-ink:none] [text-underline-position:from-font] decoration-solid font-['Inter:Regular',sans-serif] font-normal leading-[normal] not-italic relative shrink-0 text-[16px] text-black text-center text-nowrap underline whitespace-pre">Forgot Password?</p>
    </div>
  );
}
...
export default function Component3LogIn() {
  return (
