import svgPaths from "./svg-mrsliac75g";
...
function ListingSmall() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-center overflow-clip relative shrink-0" data-name="Listing Small">
...
export default function Component5Shopping() {
  return (
