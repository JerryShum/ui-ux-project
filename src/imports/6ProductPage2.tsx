import svgPaths from "./svg-2oh1kbo84q";
...
function Content() {
  return (
    <div className="absolute box-border content-stretch flex flex-col gap-[20px] items-start left-0 overflow-x-clip overflow-y-auto px-[20px] py-[10px] top-[108px] w-[438px]" data-name="Content">
      <Image />
      <PageControl />
      <Frame1 />
...
function EditCloseCircle() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="Edit / Close_Circle">
...
function InterfaceSearchMagnifyingGlass() {
  return (
    <div className="relative shrink-0 size-[40px]" data-name="Interface / Search_Magnifying_Glass">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 40 40">
...
function Bar() {
  return (
    <div className="absolute bg-[#0077ca] box-border content-stretch flex gap-[49px] items-center justify-center left-0 overflow-clip px-[39px] py-[18px] rounded-tl-[20px] rounded-tr-[20px] top-[1087px] w-[440px]" data-name="Bar">
      <IOsIcon36Message />
...
export default function Component6ProductPage() {
  return (
