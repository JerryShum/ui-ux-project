import svgPaths from "./svg-6sd3dirsui";
...
function Button() {
  return (
    <div className="bg-[#ff6a39] box-border content-stretch flex flex-col gap-[5px] items-center justify-center overflow-clip p-[10px] relative rounded-[20px] shrink-0 w-[210px]" data-name="Button">
