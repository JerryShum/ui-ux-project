import svgPaths from "./svg-wqg5tuvw6i";
...
function Button() {
  return (
    <div className="absolute bg-[#0077ca] box-border content-stretch flex flex-col gap-[5px] items-center justify-center left-[calc(25%+5px)] overflow-clip p-[10px] rounded-[20px] top-[689px] w-[210px]" data-name="Button">
...
function Button1() {
  return (
    <div className="absolute bg-[#ff6a39] box-border content-stretch flex flex-col gap-[5px] items-center justify-center left-[calc(25%+5px)] overflow-clip p-[10px] rounded-[20px] top-[751px] w-[210px]" data-name="Button">
...
export default function Component1WelcomeButtons() {
  return (
