import svgPaths from "./svg-y697pnm2ku";
import imgRectangle1 from "figma:asset/e630deb2b1d7dd5e2cb93ee7a030e7ff8356195c.png";
import imgRectangle2 from "figma:asset/4377938aff2c0270f0898fe4890a3f169c246b44.png";
import imgRectangle3 from "figma:asset/3a867dd0e62c252d355f3811356779214a8d0924.png";
import imgRectangle4 from "figma:asset/155d046f67e48be775633761458210eb604d5a71.png";
...
function Textbooks() {
  return (
    <div className="bg-[#0077ca] box-border content-stretch flex flex-col gap-[10px] items-center p-[5px] relative rounded-[10px] shrink-0 w-[70px]" data-name="Textbooks">
      <FileNotebook />
...
function Listing() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start justify-center overflow-clip relative shrink-0" data-name="Listing">
...
function Profile() {
  return (
    <div className="absolute left-[367px] size-[51px] top-[44px]" data-name="Profile">
...
export default function Component4Home() {
  return (
