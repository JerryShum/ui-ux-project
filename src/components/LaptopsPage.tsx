...
function ListingGroup() {
   return (
      <div
         className="content-stretch flex gap-[40px] items-start justify-center relative shrink-0 w-[410px]"
...
function Content() {
   return (
      <div
         className="absolute box-border content-stretch flex flex-col gap-[20px] h-[775px] items-start left-0 overflow-x-clip overflow-y-auto px-[20px] py-[10px] top-[108px] w-[438px]"
         data-name="Content"
      >
         <Searcg />
         <FeaturedListings />
