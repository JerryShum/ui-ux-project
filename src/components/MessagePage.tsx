...
import svgPaths from "../imports/svg-btdyvdxtrj";
...
function Button() {
  return (
    <div className="bg-[#ff6a39] relative rounded-[3.35544e+07px] shrink-0 size-[44px] cursor-pointer hover:opacity-90 transition-opacity" data-name="Button">
...
function Content() {
  return (
    <div className="absolute bg-[rgba(0,119,202,0.18)] box-border content-stretch flex flex-col gap-[20px] h-[704px] items-center left-0 overflow-x-clip overflow-y-auto px-[20px] py-[10px] rounded-[20px] top-[110px] w-[440px]" data-name="Content">
      <ProductPreview />
      <MessageBubble />
      <MessageBubble1 />
      <MessageBubble2 />
...
function ArrowBack() {
  ...
  return (
    <div onClick={() => navigate('/product')} className="relative shrink-0 size-[40px] cursor-pointer hover:opacity-70 transition-opacity" data-name="arrow_back">
