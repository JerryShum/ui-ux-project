...
const imgRectangle1 =
   'https://images.unsplash.com/photo-1588912914017-923900a34710?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZXh0Ym9vayUyMGFsZ2VicmF8ZW58MXx8fHwxNzY0MzczNDQyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral';
const imgRectangle2 =
   'https://images.unsplash.com/flagged/photo-1576697010739-6373b63f3204?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYXB0b3AlMjBjb21wdXRlciUyMGRlc2t8ZW58MXx8fHwxNzY0MzYzOTU3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral';
const imgRectangle3 =
   'https://images.unsplash.com/photo-1588912914017-923900a34710?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZXh0Ym9vayUyMGFsZ2VicmF8ZW58MXx8fHwxNzY0MzczNDQyfDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral';
const imgRectangle4 =
   'https://images.unsplash.com/flagged/photo-1576697010739-6373b63f3204?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsYXB0b3AlMjBjb21wdXRlciUyMGRlc2t8ZW58MXx8fHwxNzY0MzYzOTU3fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral';
...
function IOsIcon24SearchMagnifyingGlass() {
   return (
      <div
         ...
         data-name="iOS / icon / 24 / search-magnifying-glass"
      >
         <svg
         ...
         >
            <g id="iOS / icon / 24 / search-magnifying-glass">
               <path
                  d={svgPaths.p18a01470}
                  fill="var(--fill-0, #0077CA)"
                  id="icon"
                  stroke="var(--stroke-0, #0077CA)"
               />
            </g>
         </svg>
      </div>
...
function Searcg() {
   return (
      ...
      >
         ...
         <div
            aria-hidden="true"
            className="absolute border border-[rgba(0,0,0,0.1)] border-solid inset-0 pointer-events-none rounded-[10px] shadow-[4px_6px_4px_0px_rgba(0,0,0,0.25)]"
         />
      </div>
   );
}
...
function Textbooks() {
   return (
      <div
         className="bg-[#0077ca] box-border content-stretch flex flex-col gap-[10px] items-center p-[5px] relative rounded-[10px] shrink-0 w-[70px] cursor-pointer hover:opacity-90 transition-opacity"
         data-name="Textbooks"
      >
         <FileNotebook />
...
function EditEditPencilLine() {
   return (
      <div
         className="relative shrink-0 size-[30px]"
         data-name="Edit / Edit_Pencil_Line_01"
      >
         <svg
            className="block size-full"
            fill="none"
...
function SystemDesktopTower() {
   return (
      <div
         className="relative shrink-0 size-[30px]"
         data-name="System / Desktop_Tower"
      >
         <svg
            className="block size-full"
            fill="none"
...
function Text() {
   return (
      <div
         ...
         data-name="Text"
      >
         <p className="font-['Inter:Bold',sans-serif] font-bold leading-[normal] not-italic relative shrink-0 text-[14px] text-black text-nowrap whitespace-pre">
...
function Listing() {
   return (
      <div
         className="content-stretch flex flex-col gap-[10px] items-start justify-center overflow-clip relative shrink-0 cursor-pointer hover:opacity-90 transition-opacity"
         data-name="Listing"
      >
...
function ListingGroup() {
   return (
      <div
         className="content-stretch flex gap-[20px] items-start relative shrink-0 w-[410px]"
         data-name="Listing Group"
      >
         <Listing />
         <Listing1 />
      </div>
...
function Content() {
   return (
      <div
         className="absolute box-border content-stretch flex flex-col gap-[20px] h-[775px] items-start left-0 overflow-clip px-[20px] py-[10px] top-[108px] w-[438px]"
         data-name="Content"
      >
         <Searcg />
         <Categories />
...
function Profile() {
   return (
      <div
         className="absolute left-[367px] size-[51px] top-[44px] cursor-pointer hover:opacity-90 transition-opacity"
         data-name="Profile"
      >
         <img
            alt=""
   ...
   return (
      <div className="absolute contents left-[23px] top-[44px]">
         <div className="absolute capitalize flex flex-col font-['Inter:Bold',sans-serif] font-bold justify-center leading-[0] left-[122.5px] not-italic text-[#0077ca] text-[32px] text-center text-nowrap top-[72.5px] translate-x-[-50%] translate-y-[-50%]">
            <p className="leading-[normal] whitespace-pre text-xl">
         ...
         <div className="absolute bottom-[-4.55%] left-0 right-[-0.89%] top-0">
            ...
            >
               <g id="Group 13">
                  ...
                  <g id="Group 12">
                     <path
                        d={svgPaths.p186cc200}
                        fill="var(--fill-0, #1E1E1E)"
                        id="Vector (Stroke)"
                     />
                     <path
                        clipRule="evenodd"
                        d={svgPaths.p31b47400}
                        fillRule="evenodd"
                        id="Vector (Stroke)_2"
                        stroke="var(--stroke-0, #1E1E1E)"
                     />
...
function TopIcons() {
   return (
      <div
         className="absolute box-border content-stretch flex items-start justify-between left-0 overflow-clip px-[20px] py-[9px] top-0 w-[440px]"
         data-name="Top Icons"
      >
...
export default function HomePage() {
   return (
      <div
         className="bg-white overflow-clip relative rounded-[20px] size-full"
         data-name="4 - Home"
      >
         <BottomNavBar />
         <Content />
